...
exports.SRT76 = async (prefix) => {
  ...
  try {
    ...
    resultsString = `🙌 SRT-7 6. Retirement Nullification ${sort}. ${itemPrefix} test passed`;
    ...
    createDoc(`ERROR SRT-7 6. Retirement Nullifications ${sort}. ${itemPrefix}`, `ERROR: SRT-7 Generic Workflow Retirement Nullifications: ${itemPrefix}`, results);
    resultsString = `❌ ERROR: SRT-7 6. Retirement Nullifications ${sort}. ${itemPrefix}: ${err}`;
